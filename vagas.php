...
<html lang="en">
  ...
  $query = mysqli_query($link, "SELECT * FROM vagas ORDER BY cidadeempresa ASC");
  ...
  <nav class="navbar navbar-expand-lg bg-light fw-semibold">
    ...
    <div class="cadastro"><br><br>
        <center><h4>VAGAS CADASTRADAS</h4><br>
        ...
        <?php 
            if($total > 0){
                while($linha = mysqli_fetch_assoc($query)) {
                    ...
                    echo "<b>Código: </b>" . $linha['codigo'] ."<br><b> Nome da empresa: </b>" . $linha['nomeempresa'] . "<b><br>Cidade: </b>" . $linha['cidadeempresa'] .
                    "<br><b> E-mail: </b> ". $linha['emailempresa']. "<br><b> Telefone: </b> ". $linha['telefoneempresa']. "<br><b> Descrição da vaga: </b> ". $linha['descricao']. "<br><br>
                ...
                echo "<label class='label'>Não existe vagas cadastradas no momento!</label>";
            }
