...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg bg-light fw-semibold">
    ...
    <div class="cadastro"><br><br>
        <center><h4>CADASTRO DE VOLUNTÁRIOS</h4><br>

        <br>
        <form method="post" action="cadastrovoluntario.php">

            <input type="text" required="true" name="nomevoluntario" id="nomevoluntario"  value="" class="txtarea" placeholder="Nome do voluntário" maxlength="60"  /><br /><br />

            <input type="text" required="true" name="cidadevoluntario" id="cidadevoluntario"  value="" class="txtarea" placeholder="Cidade" maxlength="60"  /><br /><br />

            <input type="text" required="true" name="emailvoluntario" id="emailvoluntario"  value="" class="txtarea" placeholder="E-mail" maxlength="60"  /><br /><br />
